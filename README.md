...
- We currently target .NET Standard 2.0, [.NET 5.0](https://devblogs.microsoft.com/dotnet/announcing-net-5-0/), [.NET 6.0](https://devblogs.microsoft.com/dotnet/announcing-net-6/) and [.NET 7.0 RC2](https://devblogs.microsoft.com/dotnet/announcing-dotnet-7-rc-2/). Use the .NET 6.0 build if you're using a modern .NET version as that's a LTS version, use .NET Standard 2.0 for backwards compatibility with .NET Framework 4.6.1+

...
dotnet build ./src/sdk/PnP.Core.Transformation/PnP.Core.Transformation.csproj --configuration Release --no-incremental /p:Version=$versionUnreleased

Write-Host "Building PnP.Core.Transformation.SharePoint version $version"
dotnet build ./src/sdk/PnP.Core.Transformation.SharePoint/PnP.Core.Transformation.SharePoint.csproj --configuration Release --no-incremental /p:Version=$versionUnreleased
...
dotnet pack ./src/sdk/PnP.Core.Transformation/PnP.Core.Transformation.csproj --configuration Release --no-build /p:PackageVersion=$versionUnreleased

Write-Host "Packinging PnP.Core.Transformation.SharePoint version $version"
dotnet pack ./src/sdk/PnP.Core.Transformation.SharePoint/PnP.Core.Transformation.SharePoint.csproj --configuration Release --no-build /p:PackageVersion=$versionUnreleased
...
$transformationNupkg = $("./src/sdk/PnP.Core.Transformation/bin/Release/PnP.Core.Transformation.$versionUnreleased.nupkg")
$transformationSharePointNupkg = $("./src/sdk/PnP.Core.Transformation.SharePoint/bin/Release/PnP.Core.Transformation.SharePoint.$versionUnreleased.nupkg")

...
You do **not** need to register an application. The sample defaults to the multi-tenant PnP
application (`31359c7f-bd7e-475c-86db-fdb8c937548e`), which is the same one the other PnP Core
samples use.

> **First run on a tenant that has not used it before**, an administrator has to consent once:
>
> ```
> https://login.microsoftonline.com/<your-tenant>.onmicrosoft.com/adminconsent?client_id=31359c7f-bd7e-475c-86db-fdb8c937548e&state=12345&redirect_uri=https://www.pnp.com
> ```
>
> If you would rather use your own application registration, put its id in `appsettings.json` — see

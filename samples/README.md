...
-------|-------------|-----------------|-------------|----------------
[ASPNet Core site](Demo.ASPNetCore/README.md) | Demo application showing how use the PnP Core SDK from an ASP.Net Core application | .NET 10 | v1.17.* | Custom authentication is used via the (`ExternalAuthenticationProvider`)

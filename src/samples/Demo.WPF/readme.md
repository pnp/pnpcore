...
- Enter a name for your new app, make sure *Accounts in this organizational directory only* is selected As the Redirect URI, in Web platform enter __https://localhost__ (only needed if you want use an interactive authentication flow)

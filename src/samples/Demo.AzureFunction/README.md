...
![Publish profile in Visual Studio](./Assets/vs-publishprofile01.png)

- For each setting for which a Remote value is not yet specified, click the **Insert value from Local** link

![Specify remote app settings from Visual Studio](./Assets/vs-appsettings-remote.png)
...
![Azure Portal - Azure Functions TLS/SSL settings](./Assets/azfunc-tlsssl-tab.png)
![Azure Portal - Private Key Certificate settings](./Assets/azfunc-cert.png)
![Azure Portal - Upload certificate](./Assets/azfunc-upload-cert.png)
...
![Azure Portal - Azure Function Test Run](./Assets/azfunc-testrun1.png)
![Azure Portal - Azure Function Test Run - Output](./Assets/azfunc-testrun2.png)

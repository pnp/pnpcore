    ...
    public class GraphRestTransitionTests
    {
        ...
        public async Task GetLists()
        {
            ...
            using (var context = await TestCommon.Instance.GetContextAsync(TestCommon.TestSite))
            {
                ...
                var documentsViaGraph = webViaGraph.Lists.FirstOrDefault(p => p.Title == "Documents");
                ...
                using (var context2 = await TestCommon.Instance.GetContextAsync(TestCommon.TestSite, 1))
                {
                    ...
                    // Grab the "Documents" library and verify it has the needed Graph+Rest metadata loaded
                    var documentsViaRest = webViaRest.Lists.FirstOrDefault(p => p.Title == "Documents");
                    Assert.IsTrue(documentsViaGraph != null);
                    ...
                    foreach (var graphList in webViaGraph.Lists)
                    {
                        var restList = webViaRest.Lists.FirstOrDefault(p => p.Id == graphList.Id);

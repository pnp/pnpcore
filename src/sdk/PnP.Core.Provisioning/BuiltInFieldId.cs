// Ported verbatim from PnP Framework (PnP.Framework.Enums.BuiltInFieldId).
//
// A flat table of the ~520 field ids SharePoint ships with, and nothing more. The provisioning
// engine needs it for one decision - "did a person add this field, or was it always there" - which
// extraction asks of every field on every site. PnP Core has no equivalent, and the list is data
// rather than logic, so it is copied rather than reimplemented: any edit here would be a

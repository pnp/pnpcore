...
namespace PnP.Core.Provisioning.Utilities
{
    ...
    public static class PnPCoreUtilities
    {
        ...
        // The CSOM GetTenantAdministrationUrl(this Web web) extension that lived here was dropped: it
        // was never used by the provisioning engine, and PnP Core exposes the equivalent through
        // ISharePointAdmin.GetTenantAdminCenterUriAsync().
    }
}

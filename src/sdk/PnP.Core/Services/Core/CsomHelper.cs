...
namespace PnP.Core.Services
{
    internal static class CsomHelper
    {
        ...
        internal static string PropertyBagUpdate = "<Request AddExpandoFieldTypeSuffix=\"true\" SchemaVersion=\"15.0.0.0\" LibraryVersion=\"16.0.0.0\" ApplicationName=\"pnp core sdk\" xmlns=\"http://schemas.microsoft.com/sharepoint/clientquery/2009\"><Actions>{FieldValues}<Method Name=\"Update\" Id=\"{Counter}\" ObjectPathId=\"11\" /></Actions><ObjectPaths><Property Id=\"7\" ParentId=\"11\" Name=\"Properties\" /><Identity Id=\"11\" Name=\"121a659f-e03e-2000-4281-1212829d67dd|740c6a0b-85e2-48a0-a494-e0f1759d4aa7:site:{Site.Id}:web:{Web.Id}:folder:{Parent.Id}\" /></ObjectPaths></Request>";

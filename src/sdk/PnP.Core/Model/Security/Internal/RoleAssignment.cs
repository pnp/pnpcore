...
namespace PnP.Core.Model.Security
{
    ...
    [SharePointType("SP.RoleAssignment", Target = typeof(ListItem), Uri = "_api/Web/Lists(guid'{List.Id}')/Items({Parent.Id}/RoleAssignments/GetByPrincipal({PrincipalId})", Get = "_api/Web/Lists(guid'{List.Id}')/Items({Parent.Id}//RoleAssignments", LinqGet = "_api/Web/Lists(guid'{List.Id}')/Items({Parent.Id}/RoleAssignments")]

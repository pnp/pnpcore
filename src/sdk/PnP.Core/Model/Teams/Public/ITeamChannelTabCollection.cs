...
namespace PnP.Core.Model.Teams
{
    ...
    public interface ITeamChannelTabCollection : IDataModelCollection<ITeamChannelTab>, ISupportPaging<ITeamChannelTab>, IDataModelCollectionDeleteByGuidId, ISupportQuery<ITeamChannelTab>
    {
        /// <summary>

...
namespace PnP.Core.Model.Teams
{
    ...
    public interface ITeamChannelTab : IDataModel<ITeamChannelTab>, IDataModelGet<ITeamChannelTab>, IDataModelLoad<ITeamChannelTab>, IDataModelDelete, IDataModelUpdate
    {
        /// <summary>

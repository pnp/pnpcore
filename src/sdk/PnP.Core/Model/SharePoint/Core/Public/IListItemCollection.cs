...
namespace PnP.Core.Model.SharePoint
{
    ...
    public interface IListItemCollection : IQueryable<IListItem>, IDataModelCollection<IListItem>, IDataModelCollectionLoad<IListItem>, IDataModelCollectionDeleteByIntegerId
    {
        #region Add methods
        /// <summary>

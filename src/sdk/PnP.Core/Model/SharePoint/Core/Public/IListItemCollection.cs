...
namespace PnP.Core.Model.SharePoint
{
    ...
    public interface IListItemCollection : IQueryable<IListItem>, IDataModelCollection<IListItem>, ISupportPaging<IListItem>, IDataModelCollectionDeleteByIntegerId
    {
        #region Add methods
        /// <summary>

...
namespace PnP.Core.Model.SharePoint
{
    ...
    public interface IFolder : IDataModel<IFolder>, IDataModelGet<IFolder>, IDataModelLoad<IFolder>, IDataModelUpdate, IDataModelDelete, IDataModelWithChanges, IQueryableDataModel
    {
        /// <summary>

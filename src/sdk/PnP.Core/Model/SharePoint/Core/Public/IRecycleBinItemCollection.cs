...
namespace PnP.Core.Model.SharePoint
{
    ...
    public interface IRecycleBinItemCollection : IQueryable<IRecycleBinItem>, IDataModelCollection<IRecycleBinItem>, IDataModelCollectionLoad<IRecycleBinItem>, IDataModelCollectionDeleteByGuidId
    {
        #region Methods

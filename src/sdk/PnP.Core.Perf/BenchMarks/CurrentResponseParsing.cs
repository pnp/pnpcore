...
{
    public class CurrentResponseParsing
    {
        internal static readonly Regex arrayMatchingRegex = new Regex(@"\[(?<index>[0-9]+)\]", RegexOptions.Compiled);

        internal static async Task<bool> FromJsonRest(TransientObject pnpObject, EntityInfo entity, ApiResponse apiResponse, Func<FromJson, object> fromJsonCasting = null)
        {
        ...
        internal static void SetBatchRequestId(TransientObject pnpObject, Guid batchRequestId)
        {
        ...
        internal static EntityFieldInfo LookupEntityField(EntityInfo entity, ApiResponse apiResponse, JsonProperty property)
        {
        ...
        internal static void AddToDictionary(TransientDictionary dictionary, string key, object value, TransientObject pnpObject)
        {
        ...
        internal static IField GetListItemField(TransientObject pnpObject, string fieldName)
        {
